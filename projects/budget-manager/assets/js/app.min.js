...
"use strict";angular.module("paymentCycle").config(["$stateProvider","$urlRouterProvider","$httpProvider",function(t,e,a){t.state("dashboard",{url:"/dashboard",templateUrl:"dashboard/dashboard.html"}).state("paymentCycle",{url:"/paymentCycle?page",templateUrl:"paymentCycles/tabs.html"}),a.interceptors.push("handleResponseError")}]).run(["$rootScope","$http","$location","$window","auth",function(t,e,a,o,r){function n(){var t=r.getUser(),n="/projects/budget-manager/auth.html",l=o.location.href.includes(n);t||l?t&&!t.isValid&&r.validateToken(t.token,function(r,i){i?(t.isValid=!0,e.defaults.headers.common.Authorization=t.token,l?o.location.href="/":a.path("/dashboard")):o.location.href=n}):o.location.href=n}n(),t.$on("$locationChangeStart",function(){return n()})}]);
